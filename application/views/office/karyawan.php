      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-light">
            <h3 class="card-title"><i class="fa fa-list text-blue"></i> Data karyawan</h3>
            <div class="text-right">
              <a href="<?= base_url('karyawan/download'); ?>" type="button" class="btn btn-sm btn-outline-info" title="Download" target="_blank"><i class="fas fa-download"></i> Download</a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#tabelsubmenu").DataTable({
      ...
      "autoWidth": false,
      "language": {
        "sEmptyTable": "Data karyawan Belum Ada"
      },
      ...
      "ajax": {
        "url": "<?php echo site_url('aset_pegawai/ajax_list') ?>",
        "type": "POST"
      },
      ...
      "columnDefs": [{
          ...
          "render": function(data, type, row) {
            ...
            return "<a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit_karyawan(" + row[9] + ")\"><i class=\"fas fa-edit\"></i></a>";
  ...
  function edit_karyawan(id) {
    ...
    $.ajax({
      url: "<?php echo site_url('karyawan/edit_karyawan') ?>/" + id,
      type: "GET",
      dataType: "JSON",
  ...
  function save() {
    ...
    var url = "<?php echo site_url('karyawan/update') ?>";
        ...
        <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="card-body">
            ...
            <div class="form-group row ">
              ...
              <div class="col-sm-9 kosong">
                <input type="text" class="form-control" name="tahun" id="tahun" placeholder="Nama karyawan">
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group row ">
