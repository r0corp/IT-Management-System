...
{
	var $table = 'aset_divisi';
	var $column_search = array('nama_divisi');
	var $column_order = array('nama_divisi');
	...
	{
		$this->db->where('id', $id);
		$this->db->update('aset_divisi', $data);
	}

	function get_departement($id)
	{
		$this->db->where('id', $id);
		return $this->db->get('aset_divisi')->row();
	}
