...
{
    var $table = 'divisi';
    var $column_search = array('id_divisi', 'nama_divisi');
    var $column_order = array('id_divisi', 'nama_divisi');
    ...
    function insert_divisi($table, $data)
    {
    ...
    function delete_divisi($id, $table)
    {
        $this->db->where('id_divisi', $id);
