...
class Karyawan extends MY_Controller
{
    ...
    {
        $this->template->load('layoutbackend', 'aset/karyawan');
    }
    ...
    public function edit_karyawan($id)
    {
        ...
        $data = $this->Mod_karyawan->getkaryawan($id);
    ...
    public function update()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $g = $this->Mod_karyawan->getImage($id)->row_array();
                ...
                $this->Mod_karyawan->updatekaryawan($id, $save);
    ...
    public function download()
    {
        ...
        $karyawan = $this->Mod_karyawan->getAll()->result();
        $no = 1;
        $x = 2;
        foreach ($karyawan as $row) {
            $sheet->setCellValue('A' . $x, $no++);
            $sheet->setCellValue('B' . $x, $row->nama_karyawan);
